...
${OBJECTDIR}/Balcao.o: Balcao.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Balcao.o Balcao.c
...
${OBJECTDIR}/Meal.o: Meal.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Meal.o Meal.c
...
${OBJECTDIR}/queueMeal.o: queueMeal.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queueMeal.o queueMeal.c

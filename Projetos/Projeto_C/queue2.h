...
#define QUEUE_FULL          4
    ...
    int queueDestroy2(PtQueue *ptQueue);
    ...
    int queueEnqueue2(PtQueue queue, QTypeElem elem);
    ...
    int queueSize2(PtQueue queue, int *ptSize);
    /* Verifica se a fila está vazia. 
     Devolve: 1 caso esteja vazia ou seja NULL; 0 não se encontre vazia. */
    int queueIsEmpty2(PtQueue queue);
